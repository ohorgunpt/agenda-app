...
<head>
    ...
    <title>SICANDA</title>
    <meta content="" name="description">assets/vendor/php-email-form/validate.js
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <h1 class="logo me-auto me-lg-0"><a href="#">SICANDA</a></h1>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container d-flex flex-column align-items-center" data-aos="zoom-in" data-aos-delay="100">
            <h1>SICANDA</h1>
            <h2>Sistem Informasi Pencatatan Agenda`</h2>
            <a href="{{ route('login') }}" class="btn-about">Login</a>
        </div>
    </section><!-- End Hero -->
